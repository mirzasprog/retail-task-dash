...
public class DashboardController : ControllerBase
{
    ...
    [ProducesResponseType(typeof(IEnumerable<SalesCategoryBreakdown>), StatusCodes.Status200OK)]
    public async Task<IActionResult> GetCategoryBreakdown(Guid storeId, CancellationToken cancellationToken)
    {
        var categories = await _dashboardService.GetCategoryBreakdownAsync(storeId, cancellationToken);
